...
<link
	href="/pages/admin/vendor/fontawesome-free/css/all.min.css"
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.html"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Chỉnh
						sửa sản phẩm</span></a></li>
			<li class="nav-item active"><a class="nav-link"
				href="index.html"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Thêm
