...
<link href="<c:url value="/pages/admin/vendor/fontawesome-free/css/all.min.css"/>"
...
<link href="<c:url value="/pages/admin/css/sb-admin-2.min.css"/>" rel="stylesheet">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid row">
					<form method="POST"
						action='<c:url value = "<%=Constants_Value.ADMIN_ORDER_SEARCH_URL%>"></c:url>'>
						<div class="form-row">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								<label>Trạng thái</label> orderStatus <select
									name="order_status_id" class="form-control form-control-md">
									<option value="">
						...
						<tbody>
							<c:forEach items="${requestScope.orderList}" var="order">
								<tr>
									...
									<td><a
										href="<c:url value ="<%=Constants_Value.ADMIN_ORDER_HANDLE_URL%>"/>?id=${order.orderID}"
